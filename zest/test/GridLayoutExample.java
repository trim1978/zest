...
public class GridLayoutExample extends AbstractExample {
	...
	private Shape createShape_() {
		switch (shapeCount) {
		case 0: return new Ellipse();
		case 1: return new RectangleFigure();
		case 2: return new RoundedRectangle();
		case 3: return new RectangleFigure();
		case 4: return new Ellipse();
		case 5: return new Triangle();
		case 6: return new RoundedRectangle();
		case 7: return new Triangle();
		default: return new RoundedRectangle();
		}
	}

	
	protected Shape createShape() {
		Shape shape = createShape_();
