...
public interface IFigure {
	...
	/**
	 * Adds the child with the specified index and constraint. The child's parent is
	...
	/**
	 * Returns the preferred size for this IFigure. The returned value must not be
	...
	/**
	 * Unregisters the given listener, so that it will no longer receive
	 * notification of changes in the given property. This will only unregister the
	...
	/**
	 * Invalidates this figure and revalidates() its parent. If a figure does not
	 * have a parent, it will request a validation from it UpdateManager. Calling
	 * this method does not guarantee that a repaint will occur.
	 */
	void revalidate();
	 ...
	 * children figures. Default validation uses pre-order, depth-first ordering.
	 */
	void validate();
