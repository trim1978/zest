...
public class Figure implements IFigure {
	...
	public void addLayoutListener(LayoutListener listener) {
		if (layoutManager instanceof LayoutNotifier) {
			((LayoutNotifier)layoutManager).listeners.add(listener);
		} else {
	...
	public void handleKeyPressed(KeyEvent event) {
		Iterator<KeyListener> iter = eventListeners.getListeners(KeyListener.class);
	...
	public void handleMouseDoubleClicked(MouseEvent event) {
		Iterator<MouseListener> iter = eventListeners.getListeners(MouseListener.class);
		while (!event.isConsumed() && iter.hasNext()) {
	...
	public void handleMouseDragged(MouseEvent event) {
		Iterator<MouseMotionListener> iter = eventListeners.getListeners(MouseMotionListener.class);
		while (!event.isConsumed() && iter.hasNext()) {
	...
	public void handleMouseWheelScrolled(MouseEvent event) {
		Iterator<MouseWheelListener> iter = eventListeners.getListeners(MouseWheelListener.class);
		while (!event.isConsumed() && iter.hasNext()) {
