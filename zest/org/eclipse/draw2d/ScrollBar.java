	...
	public void setDownClickable(Clickable down) {
		...
		if (buttonDown != null) {
			if (buttonDown instanceof Orientable) {
				((Orientable)buttonDown).setDirection(isHorizontal() ? PositionConstants.EAST : PositionConstants.SOUTH);
			}
	...
	public void setUpClickable(Clickable up) {
		...
		if (up != null) {
			if (up instanceof Orientable) {
				((Orientable)up).setDirection(isHorizontal() ? PositionConstants.WEST : PositionConstants.NORTH);
			}
